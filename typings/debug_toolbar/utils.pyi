...
def get_template_source_from_exception_info(node: Node, context: stubs.RequestContext) -> tuple[int, list[tuple[int, str]], str]:
    ...
...
def sanitize_and_sort_request_vars(variable: dict[str, Any] | QueryDict) -> dict[str, list[tuple[str, Any]] | Any]:
    """
...
class _StackTraceRecorder:
    ...
    def get_stack_trace(self, *, excluded_modules: Sequence[str] | None = ..., include_locals: bool = ..., skip: int = ...): # -> list[Any]:
        ...
